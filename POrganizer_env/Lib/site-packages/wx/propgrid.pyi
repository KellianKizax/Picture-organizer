...
class PGCellRenderer(wx.RefCounter):
    ...
    def PreDrawCell(self, dc, rect, propGrid, cell, flags):
        """
...
class PropertyGridInterface(object):
    ...
    def SetPropertyCell(self, id, column, text=wx.EmptyString, bitmap=wx.BitmapBundle(), fgCol=wx.NullColour, bgCol=wx.NullColour):
        """
        SetPropertyCell(id, column, text=wx.EmptyString, bitmap=wx.BitmapBundle(), fgCol=wx.NullColour, bgCol=wx.NullColour)
...
class ArrayStringProperty(EditorDialogProperty):
    ...
    def ConvertArrayToString(self, arr, delimiter):
        """
        ConvertArrayToString(arr, delimiter) -> String
    ...
    @staticmethod
    def ArrayStringToString(src, delimiter, flags):
        """
        ArrayStringToString(src, delimiter, flags) -> String
...
class PropertyGridManager(wx.Panel, PropertyGridInterface):
    ...
    def AddPage(self, label=wx.EmptyString, bmp=wx.BitmapBundle(), pageObj=None):
        """
        AddPage(label=wx.EmptyString, bmp=wx.BitmapBundle(), pageObj=None) -> PropertyGridPage
    ...
    def InsertPage(self, index, label, bmp=wx.BitmapBundle(), pageObj=None):
        """
